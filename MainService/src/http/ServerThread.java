    ...
    public void run() {
        try {
            ...
            if (method.equals(HttpMethod.POST.toString())) {
                ...
                String[] vrednosti = s.split("&");
                String autor = vrednosti[0].substring(s.indexOf("=")+1, s.indexOf("&"));
                String citat = vrednosti[1].substring(s.indexOf("="));

                String ceoString = autor + ": " + '"' + citat + '"';
//                System.out.println(ceoString);
                quotes.add(ceoString);
            }
